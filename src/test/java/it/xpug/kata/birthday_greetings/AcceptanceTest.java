...
import it.xpug.kata.birthday_greetings.infra.LineEmployeeRepository;
import it.xpug.kata.birthday_greetings.infra.MailSender;
...
public class AcceptanceTest {
    ...
    public void setUp() {
        ...
        birthdayService = new BirthdayService(new MailSender("localhost", NONSTANDARD_PORT), new LineEmployeeRepository("employee_data.txt"));
    }
